...
Confirm the install with `bex -v` — it prints bex's release version (e.g. `bex v0.1.0` plus `compatible with Render CLI v2.27.0`) and tells you when a newer release exists.
