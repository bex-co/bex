...
func placementResource() *appv1alpha1.Database {
	obj := sampleDatabase("placement")
...
func readPlacement(t *testing.T, cl client.Client) *appv1alpha1.Database {
	t.Helper()
	var obj appv1alpha1.Database
