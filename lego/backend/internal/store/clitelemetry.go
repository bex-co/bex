...
// the imported CLI's sender needs no translation.
	...
	_, err := s.Pool.Exec(ctx, `
		INSERT INTO cli_telemetry_events
			(id, subject, workspace_id, reported_workspace_id, command,
			 ...
			 output_format, installation_id, launched_full_screen_tui,
		...
		ev.OutputFormat, ev.InstallationID, ev.LaunchedFullScreenTUI,
