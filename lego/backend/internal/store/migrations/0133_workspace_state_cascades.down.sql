-- Dropping the constraints cannot restore already-deleted orphan/workspace rows.
ALTER TABLE service_event_index DROP CONSTRAINT service_event_index_workspace_fk;
ALTER TABLE datastore_observed_checkpoints DROP CONSTRAINT datastore_observed_checkpoints_workspace_fk;
ALTER TABLE datastore_event_facts DROP CONSTRAINT datastore_event_facts_workspace_fk;
ALTER TABLE jobs DROP CONSTRAINT jobs_workspace_fk;
DROP INDEX jobs_tenant_id_idx;
DROP INDEX datastore_observed_checkpoints_workspace_idx;
