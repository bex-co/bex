...
**Bounded production trial (w7/047) — started 2026-09-17 at 02:41:04 UTC.** Commit `94246d5b9` enabled the gate and an absolute hard stop of **2026-09-20T02:34:30Z**; the manager rolled successfully through its Argo application. Fresh admission measured 42.135% PVC use, a retained peak of 45.138%, and 19.527 GiB reserve above that peak to the 65% ceiling. The first review is due around **2026-09-19T02:41:04Z**. The trial remains pending its measured retain-or-rollback decision; enabling the flag is not permanent acceptance. The [drill record](drills/2026-09-09-build-cache-enablement.md) carries verification and limitations.
